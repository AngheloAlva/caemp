...
export default function Hero() {
	return (
		<section className="relative flex h-[calc(100dvh-15rem)] w-full items-center justify-center overflow-hidden py-20 md:py-32">
			...
			<div className="container mx-auto px-4">
				<div className="mx-auto max-w-4xl text-center">
					...
					<SlideIn direction="up" delay={0.2}>
						<p className="mb-8 text-xl text-gray-700 md:text-2xl lg:text-3xl">
					...
					<SlideIn direction="up" delay={0.4}>
						<p className="mb-12 text-lg text-gray-600 md:text-xl">
							...
							<span className="text-primary font-semibold">seguros, conscientes y productivos</span>
							.
						</p>
					</SlideIn>
