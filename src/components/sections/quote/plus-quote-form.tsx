											...
											>
												{options.map(({ label, value }) => (
													<ToggleGroupItem
														...
														key={value}
														disabled={false}
														className="data-[spacing=0]:data-[variant=outline]:first:border-lz hover:text-primary-green data-[state=on]:text-primary-green h-full min-h-12 justify-start rounded-lg border py-3 text-left whitespace-normal data-[spacing=0]:rounded-lg data-[spacing=0]:shadow-none data-[spacing=0]:first:rounded-lg data-[spacing=0]:last:rounded-lg data-[spacing=0]:data-[variant=outline]:border"
													>
