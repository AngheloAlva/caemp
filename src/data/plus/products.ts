...
export const Products: Record<string, Product> = {
	...
	"arnes-eqs-basic-4d-respaldo-lumbar": {
		slug: "arnes-eqs-basic-4d-respaldo-lumbar",
		name: "Arnés EQS Basic 4D Respaldo Lumbar",
		image: "arnes-eqs-basic-4d-respaldo-lumbar.png",
		description:
	...
	"desfibrilador-externo-automatico-dea-aed-7000-certificado-isp-chile": {
		...
		image: "desfibrilador-externo-automatico-dea-aed-7000-certificado-isp-chile.png",
		description:
	...
	"guante-steelpro-antivibracion": {
		slug: "guante-steelpro-antivibracion",
		name: "Guante Steelpro Antivibración",
		image: "guante-steelpro-antivibracion.png",
		description:
